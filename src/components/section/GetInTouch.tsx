        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="bg-white dark:bg-purple-800 text-purple-500 dark:text-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="mt-4 text-sm text-neutral-600 dark:text-neutral-400">
                A short description of the content in this card. Learn more
          ...
          <div className="bg-white dark:bg-purple-800 text-purple-500 dark:text-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="mt-4 text-sm text-neutral-600 dark:text-neutral-400">
                Another short description that highlights key points or
                features. This card will give more insight into the topic.
              </p>
              <button className="mt-6 px-4 py-2 bg-purple-500 text-white rounded-full hover:bg-purple-600 transition-all duration-300">
                Learn More
              </button>
          ...
          <div className="bg-white dark:bg-purple-800 text-purple-500 dark:text-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="mt-4 text-sm text-neutral-600 dark:text-neutral-400">
                Another description about a different topic. A concise
                explanation can be put here with a call to action.
              </p>
              <button className="mt-6 px-4 py-2 bg-purple-500 text-white rounded-full hover:bg-purple-600 transition-all duration-300">
                Learn More
              </button>
          ...
          <div className="bg-white dark:bg-purple-800 text-purple-500 dark:text-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="mt-4 text-sm text-neutral-600 dark:text-neutral-400">
                Final card with some useful information. A short description
                goes here.
              </p>
              <button className="mt-6 px-4 py-2 bg-purple-500 text-white rounded-full hover:bg-purple-600 transition-all duration-300">
                Learn More
