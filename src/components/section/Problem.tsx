...
const problems: Problem[] = [
  {
    ...
    description: "Absence de navigation au clavier pour les personnes avec un handicap",
    color: "#1e3a8a",
  },
  {
  ...
  {
    title: "Sécurité",
    description: "Les captchas visuels sont une barrière pour les personnes malvoyantes.",
    color: "#1e3a8a",
  },
]
...
export const ProblemSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!sectionRef.current || !circleRef.current || !titleRef.current || !cardsContainerRef.current) return
  ...
  return (
    ...
    >
      <div ref={circleRef} className="absolute top-1/2 left-1/2 w-24 h-24 rounded-full bg-blue-900 opacity-55 z-0" />

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <h2 ref={titleRef} className="text-6xl md:text-8xl font-extrabold text-center mb-16 opacity-0">
          <span className="bg-gradient-to-r from-yellow-400 via-red-500 to-purple-600 bg-clip-text text-transparent">
            Problème ?
          </span>
        </h2>

        <div ref={cardsContainerRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
