...
>
  ...
  <span className="sr-only">Toggle menu</span>
          ...
          <motion.div
            id="navbar-hamburger"
            className={`overflow-hidden w-full transition-all duration-700 ease-out ${isOpen ? "max-h-screen" : "max-h-0"}`}
          >
            <div className="grid grid-cols-2 grid-rows-5 gap-4 p-4 place-items-center">
              <motion.div className=""
                ...
                transition={{ opacity: { duration: 0.5 }, y: { duration: 0.7, ease: "easeOut" } }}
              >
            ...
            initial={{ opacity: 0, y: -50 }}
            animate={isOpen ? { opacity: 1, y: 0 } : { opacity: 0, y: -50 }}
            transition={{ opacity: { duration: 0.6, delay: 0.8 }, y: { duration: 0.7, ease: "easeOut", delay: 0.8 } }}
          >
